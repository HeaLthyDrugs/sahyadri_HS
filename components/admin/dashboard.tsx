    ...
    case "overview":
      return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          <DashboardCard title="Total Orders" value="156" trend="+12%" />
          <DashboardCard title="Revenue" value="₹45,678" trend="+8%" />
          <DashboardCard title="Active Users" value="1,234" trend="+15%" />
        </div>
      );
    case "packages":
      return <PackagesPage />;
